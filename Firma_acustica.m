...
%SALIDAS
%Promedio_maximos  Double. Promedio de máximos de las señales de la embarcación. [dB]
%Promedio_frec     Double. Promedio de frecuencias de las señales de la embarcación. [Hz]
%Frec_principal    Double. Vector con las 3 frecuencias principales de cada embarcación [Hz]
%Firma             Double. Vector que almacena la firma acústica de la señal. []
...
for Cont_Maximos = 1:N_Frec
    ...
    %Calculando desviaciones estándar.
